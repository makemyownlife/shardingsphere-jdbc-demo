package cn.javayong.idgenerator.server.service;
 ...
 * 编号生成器
 */
public class RedisIdGeneratorServiceForSpring {

    private final static Logger logger = LoggerFactory.getLogger(RedisIdGeneratorServiceForSpring.class);
